...
public class Post extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_A48=findViewById(R.id.spinner_grade_A48);
        spinner_A67=findViewById(R.id.spinner_grade_A67);
        spinner_A22=findViewById(R.id.spinner_grade_A22);
        spinner_A31=findViewById(R.id.spinner_grade_A31);
        spinner_A37=findViewById(R.id.spinner_grade_A37);
                ...
                if(allSpinnerSelected()){
                    ...
                    if(selectedItem_program.equals("Specialist") || selectedItem_program.equals("Major")){
                        if(pass_A48 && cnt >= 2 && avg>=2.5){
                            Toast.makeText(Post.this, "You are making the POST!!!!", Toast.LENGTH_LONG).show();
                        }
                        else{
                            Toast.makeText(Post.this, "Sorry, your grade is not enough for making the POST.", Toast.LENGTH_LONG).show();
                        }
                    }

                }
                else{
                    Toast.makeText(Post.this, "Please select every option", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
